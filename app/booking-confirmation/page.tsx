        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex gap-4 justify-center">
            ...
            <button
              ...
              className="px-6 py-2 min-[600px]:px-12 min-[600px]:py-4 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-lg transition-colors shadow-md text-base min-[600px]:text-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Confirm Booking →
            </button>
          </div>
